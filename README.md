...
1. **Executive Summary** — (https://github.com/Anuragsharma55/Aml-transaction-monitoring/blob/b73cf0795a903c5bf3bc9d637f1691b5d0231c69/page1_executive_summary.png)
2. **Risk Analysis** — risk level distribution, alert reason breakdown, top risk customers ranked by score
...
4. **Customer Details** — full per-customer risk detail table with drill-through from Risk Analysis
